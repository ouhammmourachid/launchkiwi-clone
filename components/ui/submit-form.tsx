...
export function SubmitForm() {
  return (
    <Form
      action="/launch"
      className="mt-5 flex flex-col sm:flex-row items-center gap-2 max-w-md mx-auto rounded-xl border border-dune-850 bg-dune-970 p-1.5 shadow-inner"
    >
      <input
        type="url"
        name="url"
        ...
        className="w-full bg-transparent px-3 py-2 text-xs text-white placeholder:text-dune-600 outline-none flex-1"
      />
      <button
        type="submit"
