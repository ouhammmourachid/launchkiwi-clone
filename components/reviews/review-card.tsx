  ...
  return (
    <article className="group relative flex flex-col justify-between rounded-[20px] border border-dune-850 bg-dune-940 p-5 transition hover:border-dune-750">
      <div>
        ...
        <h3 className="mt-4 text-base sm:text-lg font-black tracking-tight text-white leading-snug group-hover:text-sun transition">
          {review.title}
        </h3>

        <p className="mt-2.5 text-xs text-dune-300 leading-relaxed line-clamp-2">{product.tagline}</p>
      </div>
